...
<div class="">
    ...
    @if($role->name != 'Team Leader')
         <li class=""><a href="{{route('dashboard')}}"
                class="list-group-item border-top-0 @if($currentUrl == 'dashboard') active @endif">แดชบอร์ด</a> </li>
    ...
    @if($role->name == 'Team Leader')
        ...
        <li> <a href="/ManualAgentRev1.pdf" target="_blank" role="button" class="list-group-item border-top-0">คู่มือ Agent</a> </li>
        @endif

        @if (Auth::user()->role()->name == 'Admin' || Auth::user()->role()->name == 'AdminSupport')
        <li> <a href="/ManualAdmin78.pdf" target="_blank" role="button" class="list-group-item border-top-0">คู่มือ Admin</a> </li>
        @endif

        @if (Auth::user()->role()->name == 'AdminAgent')
                <li> <a href="/ManualAdminAgentRev1.pdf" target="_blank" role="button" class="list-group-item border-top-0">คู่มือ AdminAgent</a> </li>
        @endif
