            ...
            <tr>
                ...
                <td>
                    ...
                    @else
                        ...
                        @endphp
                        @if ($staff == 'daily')
                            <a href="javascript:;" class="{{$staff}}"  onclick="get_commission_daily('{{$commission->id}}')" >รายละเอียด</a>
                        @else
                            <a href="javascript:;" class="{{$staff}}"   onclick="get_commission('{{$commission->id}}')" >รายละเอียด</a>
                        @endif
                    @endif
                </td>
            </tr>
