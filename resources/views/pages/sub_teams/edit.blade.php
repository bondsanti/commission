                    ...
                    {{Form::model($role,['route' => ['roles.update', $role->id] , 'method' => 'put'])}}
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            {{Form::number('commission', $role->commission,['class' => 'form-control col-md-1' ,'required' => true])}}
                            {{Form::label('%','%', ['class' => 'col-md-3 col-form-label'])}}
                        </div>

                        <div class="form-group row">
                            {{Form::label('Mortgage','Mortgage', ['class' => 'col-md-3 offset-md-1 col-form-label'])}}
                            {{Form::input('number', 'mortgage', $role->mortgage,['class' => 'form-control col-md-1' ,'required' => true])}}
                        </div>

                        <div class="form-group row">
                            {{Form::label('Sale','Sale', ['class' => 'col-md-3 offset-md-1 col-form-label'])}}
                            {{Form::input('number', 'SALE', $role->SALE,['class' => 'form-control col-md-1' ,'required' => true])}}
                        ...
                        <div class="form-group row">
                            ...
                            {{Form::input('number', 'TL', $role->TL,['class' => 'form-control col-md-1' ,'required' => true])}}
                        ...
                        <div class="form-group row">
                            ...
                            {{Form::input('number', 'MG', $role->MG,['class' => 'form-control col-md-1' ,'required' => true])}}
                            
                        </div>

                        <div class="form-group row">
                            {{Form::label('SM','SM', ['class' => 'col-md-3 offset-md-1 col-form-label'])}}
                            {{Form::input('number', 'SM', $role->SM,['class' => 'form-control col-md-1' ,'required' => true])}}
                            
                        </div>

                        <div class="form-group row">
                            {{Form::label('AVP','AVP', ['class' => 'col-md-3 offset-md-1 col-form-label'])}}
                            {{Form::input('number', 'AVP', $role->AVP,['class' => 'form-control col-md-1' ,'required' => true])}}
                            
                        </div>

                        <div class="form-group row">
                            {{Form::label('VP','VP', ['class' => 'col-md-3 offset-md-1 col-form-label'])}}
                            {{Form::input('number', 'VP', $role->VP,['class' => 'form-control col-md-1' ,'required' => true])}}
                            
                        </div>

                        <div class="form-group row">
                            {{Form::label('MD','MD', ['class' => 'col-md-3 offset-md-1 col-form-label'])}}
                            {{Form::input('number', 'MD', $role->MD,['class' => 'form-control col-md-1' ,'required' => true])}}
